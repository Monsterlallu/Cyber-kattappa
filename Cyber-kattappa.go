...
/*
 ...
 Cyber-kattappa DoS tool on <strike>steroids</strike> goroutines. Just ported from Python with some improvements.
...
func main() {
	...
	flag.StringVar(&data, "data", "", "Data to POST. If present Cyber-kattappa will use POST requests instead of GET")
	...
	if version {
		...
		fmt.Println("Cyber-kattappa", __version__)
	...
	go func() {
		...
		fmt.Println("-- Cyber Attack Started --\n           Go!\n\n")
		...
		for {
			...
			case targetComplete:
				...
				fmt.Println("\r-- Cyber Attack Finished --       \n\n\r")
